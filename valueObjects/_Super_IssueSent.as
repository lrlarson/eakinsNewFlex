 ...
 * of this value object you may modify the generated sub-class of this class - IssueSent.as.
 */
...
[ExcludeClass]
public class _Super_IssueSent extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _IssueSentEntityMetadata;
    ...
    private var _internal_Date_Sent : Object;
    ...
    public function _Super_IssueSent()
    {
        _model = new _IssueSentEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get Date_Sent() : Object
    {
    ...
    public function set Date_Sent(value:Object) : void
    {
        var oldValue:Object = _internal_Date_Sent;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _IssueSentEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _IssueSentEntityMetadata) : void
    {
        var oldValue : _IssueSentEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfDate_Sent : Object;
