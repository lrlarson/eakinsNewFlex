...
internal class _EditionDetailsEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("id", "price", "weight", "book_id", "isbn", "grams", "format", "out_of_print", "not_for_sale");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("id", "price", "weight", "book_id", "isbn", "grams", "format", "out_of_print", "not_for_sale");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("id", "price", "weight", "book_id", "isbn", "grams", "format", "out_of_print", "not_for_sale");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("id", "price", "weight", "book_id", "isbn", "grams", "format", "out_of_print", "not_for_sale");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("id", "price", "weight", "book_id", "isbn", "grams", "format", "out_of_print", "not_for_sale");
