 ...
 * of this value object you may modify the generated sub-class of this class - DITransaction.as.
 */
...
[ExcludeClass]
public class _Super_DITransaction extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _DITransactionEntityMetadata;
    ...
    private var _internal_numberOfIssuesSent : int;
    private var _internal_shippingAddressCompanyName : String;
    private var _internal_transDate : String;
    ...
    public function _Super_DITransaction()
    {
        _model = new _DITransactionEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "transDate", model_internal::setterListenerTransDate));
    ...
    [Bindable(event="propertyChange")]
    public function get numberOfIssuesSent() : int
    {
    ...
    [Bindable(event="propertyChange")]
    public function get transDate() : String
    {
        return _internal_transDate;
    }
    ...
    public function set numberOfIssuesSent(value:int) : void
    {
        var oldValue:int = _internal_numberOfIssuesSent;
        if (oldValue !== value)
        {
    ...
    public function set transDate(value:String) : void
    {
        var oldValue:String = _internal_transDate;
        if (oldValue !== value)
        {
            _internal_transDate = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "transDate", oldValue, _internal_transDate));
        }
    }
    ...
    model_internal function setterListenerTransDate(value:flash.events.Event):void
    {
        _model.invalidateDependentOnTransDate();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.transDateIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_transDateValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _DITransactionEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _DITransactionEntityMetadata) : void
    {
        var oldValue : _DITransactionEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfTransDate : Array = null;
    model_internal var _doValidationLastValOfTransDate : String;

    model_internal function _doValidationForTransDate(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfTransDate != null && model_internal::_doValidationLastValOfTransDate == value)
           return model_internal::_doValidationCacheOfTransDate ;

        _model.model_internal::_transDateIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isTransDateAvailable && _internal_transDate == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "transDate is required"));
        }

        model_internal::_doValidationCacheOfTransDate = validationFailures;
        model_internal::_doValidationLastValOfTransDate = value;
